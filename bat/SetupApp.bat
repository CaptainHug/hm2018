...
:: Desktop packaging
set DESKTOP_SIGNING_OPTIONS=-tsa http://sha256timestamp.ws.symantec.com/sha256/timestamp -keystore "%AND_CERT_FILE%" -storetype pkcs12 -storepass %AND_CERT_PASS%
